...
class CombatTest {
    ...
    void resolveCombatHumanVHuman() {
        Creature winner = Combat.resolveCombat(null, new Human(), new Human(), null);
        assertTrue(winner instanceof Human, "Human vs Human failed.");
    }

    @Test
    void resolveCombatGoblinVGoblin() {
        Creature winner = Combat.resolveCombat(null, new Goblin(), new Goblin(), null);
    ...
    void resolveCombatAttWin() {
        ...
        assertEquals(h, Combat.resolveCombat(null, h, new Goblin(), null), "Attacker win failed.");
    }
    ...
    void resolveCombatDefWin() {
        ...
        Goblin g = new Goblin();
        assertEquals(g, Combat.resolveCombat(null, h, g, null), "Defender win failed.");
    }
}